  ...
  const renderPieceIcon = () => {
    switch (piece.type) {
      case 'king':
        return (
          <svg viewBox="0 0 24 24" className="w-full h-full">
            <path fill="currentColor" d="M19,22H5V20H19V22M17,10C15.58,10 14.26,10.77 13.55,12H13V7H16V5H13V2H11V5H8V7H11V12H10.45C9.74,10.77 8.42,10 7,10C4.79,10 3,11.79 3,14C3,16.21 4.79,18 7,18H17C19.21,18 21,16.21 21,14C21,11.79 19.21,10 17,10Z" />
          </svg>
        );
      case 'queen':
        return (
      ...
      case 'rook':
        return (
          <svg viewBox="0 0 24 24" className="w-full h-full">
            <path fill="currentColor" d="M5,20H19V22H5V20M17,2V5H15V2H13V5H11V2H9V5H7V2H5V8H7V18H17V8H19V2H17Z" />
          </svg>
        );
      case 'bishop':
        return (
